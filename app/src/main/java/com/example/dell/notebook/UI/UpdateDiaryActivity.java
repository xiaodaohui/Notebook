package com.example.dell.notebook.UI;
...
import com.example.dell.notebook.DB.DiaryDataBase;
import com.example.dell.notebook.MainActivity;
...
public class UpdateDiaryActivity extends AppCompatActivity {
        ...
        private DiaryDataBase mHelper;

        public static void startActivity(Context context, String title, String content, String nlabel) {
            Intent intent = new Intent(context, UpdateDiaryActivity.class);
            intent.putExtra("title", title);
            intent.putExtra("content", content);
            intent.putExtra("nlabel", nlabel);
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            mHelper = new DiaryDataBase(this, "Diary.db", null, 1);
            initTitle();
